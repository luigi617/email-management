        ...
        {mode === 'list' ? (
                    ...
                    <div key={a.id} className={styles.accountRow}>
                      <div className={styles.accountMain}>
                        <div className={styles.accountTitle}>
                          ...
                          <span
                            className={`${styles.pill} ${connected ? styles.pillOk : styles.pillBad}`}
                          >
          ...
          <div className={styles.body}>
            ...
            <div className={styles.muted} style={{ marginTop: 10 }}>
              Connected status updates when you click “Refresh status”. For OAuth2, click “Connect”
              to complete the consent flow. For app-password accounts, “Connect” means entering an
              app password so IMAP/SMTP become active.
            </div>
          </div>
        )}
      </div>
